"""Scatter router v1. Three routes + IPW logging."""
...
# Estimated watts per route. HP Spectre: idle ~5W, CPU-heavy ~30W.
# Replace with real wattmeter readings when hardware arrives.
